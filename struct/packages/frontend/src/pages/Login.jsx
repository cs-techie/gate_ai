      ...
      <div style={{ display: 'flex', flex: 1, paddingTop: '72px', minHeight: '100vh' }}>
        ...
        <div style={{ width: '40%', minHeight: 'calc(100vh - 72px)', display: 'none', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px 40px', position: 'relative', overflow: 'hidden', background: 'linear-gradient(135deg,#22C58B 0%,#4FD1A5 100%)' }} className="auth-left">
          ...
          <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <h2 style={{ fontSize: '26px', fontWeight: 800, color: '#fff', textAlign: 'center', lineHeight: 1.2, marginBottom: '10px', letterSpacing: '-0.4px' }}>Welcome Back!</h2>
            <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.82)', textAlign: 'center', maxWidth: '240px', lineHeight: 1.7, marginBottom: '32px' }}>Your AI-powered GATE preparation journey continues here</p>
            <div style={{ display: 'flex', gap: '32px', marginBottom: '28px' }}>
              {[['50K+','Students'],['130+','Tests'],['95%','Success']].map(([v, l]) => (
                <div key={l} style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '22px', fontWeight: 800, color: '#fff', lineHeight: 1 }}>{v}</div>
                  <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.7)', marginTop: '4px' }}>{l}</div>
                </div>
              ))}
            </div>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px' }}>
          <div style={{ width: '100%', maxWidth: '440px', background: '#fff', borderRadius: '22px', boxShadow: '0 10px 50px rgba(0,0,0,0.09),0 2px 6px rgba(0,0,0,0.04)', padding: '42px 40px 38px', border: '1px solid rgba(229,231,235,0.5)' }}>

            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '24px' }}>
              <img src="/images/logo.png" alt="GATEXpress AI Logo" style={{ height: '42px', width: 'auto' }} />
            </div>

            <h1 style={{ fontSize: '24px', fontWeight: 800, color: '#111827', marginBottom: '4px', letterSpacing: '-0.4px' }}>Sign In</h1>
            <p style={{ fontSize: '13px', color: '#6B7280', marginBottom: '24px' }}>
              {"Don't have an account? "}
              <Link to="/signup" style={{ color: '#22C58B', fontWeight: 600, textDecoration: 'none' }}>Create one free &rarr;</Link>
            </p>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                  ...
                  <a href="#" style={{ fontSize: '12px', fontWeight: 600, color: '#22C58B', textDecoration: 'none' }}>Forgot password?</a>
                </div>
                <div style={{ position: 'relative' }}>
            ...
            <p style={{ textAlign: 'center', fontSize: '11px', color: '#9CA3AF', marginTop: '18px', lineHeight: 1.6 }}>
